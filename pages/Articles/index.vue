<template>
  <div>
    ...
    <AppHeader class="iris-yonder">Dance Articles & Advice</AppHeader>
    <Intro
      >Our in-depth articles will guide you to become a better dancer. Enhance
      your career tips, discover health and fitness advice, and read interviews
      from dance professionals.</Intro
    >
...
export default {
  ...
  data() {
    return {
      ...
      metaItems: {
        site: 'DancePlug',
        title: 'Dance Articles & Advice | DancePlug',
        description:
          'Our in-depth articles will guide you to become a better dancer. Enhance your career tips, discover health and fitness advice, and read interviews from dance professionals.',
        coverImage:
  ...
  methods: {
    async fetchArticles(page) {
      ...
      let requestUrl = '/api/v1/articles?keywords=' + kw + cat;
      const index = page - 1;
  ...
  metaInfo() {
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: 'https://www.danceplug.com/articles',
        },
        {
          rel: 'prev',
          href:
        ...
        },
        {
          rel: 'next',
          href:
            'https://www.danceplug.com/articles?page=' +
            (this.pager.currentPage == undefined || this.pager.currentPage == 1 ?
              2 :
