<template>
  <div>
    ...
    <AppHeader class="plum-ruby">Submit Dance Event</AppHeader>
    <section>
      <script src="https://static.airtable.com/js/embed/embed_snippet_v1.js" />
      <iframe
        class="airtable-embed airtable-dynamic-height"
        src="https://airtable.com/embed/shrGRWl8zlKWXxKfj?backgroundColor=green"
        frameborder="0"
        onmousewheel
        width="100%"
        height="2936"
...
export default {
  data() {
    return {
      ...
      metaItems: {
        site: 'DancePlug',
        title: 'Promote an Upcoming Dance Event | DancePlug',
        description:
          'Looking for dancers for an upcoming project, gig or to fill an opening in your company? Or in need of a teacher, administrative help, or a choreographer?',
        coverImage:
  ...
  metaInfo() {
    return {
      ...
      link: [{rel: 'canonical', href: 'https://www.danceplug.com/list/event'}],
    };
  },
};
</script>
